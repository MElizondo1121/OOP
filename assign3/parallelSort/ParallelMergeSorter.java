 ...
 */
/**
 * This class carries out the parallel merge sort algorithm.
 */
public class ParallelMergeSorter extends Thread{
    ...
    /**
     * Sorts a range of an array, using the parallel merge sort algorithm.
     *
     * @param a the array to sort
     * @param from the first index of the range to sort
     * @param to the last index of the range to sort
    ...
    private static <E> void parallelMergeSort(E[] a, int from, int to, Comparator<? super E> comp){
       if(from < to){
          ...
          int mid = (from + to) / 2;
          //fork subtask to parallel merge sort algorithm
          Thread firstPart = new Thread(new Runnable(){
            @Override
              public void run(){
          ...
          //fork subtask to parallel merge sort algorithm
          Thread secondPart = new Thread(new Runnable(){
              @Override
              public void run(){
